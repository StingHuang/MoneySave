...
public class AccountsHelper {
	...
	public static List<Accounts> listAccounts(ContentResolver cr) {
		...
		Cursor cs = cr.query(MoneyAccountsTableMetaData.CONTENT_URI, 
													null, null, null, 
													MoneyAccountsTableMetaData._ID + sortorder_ASC);
...
//        Log.d(TAG, "listAccounts - " + iidIdx + "," + nameIdx + "," + moneyIdx);
...
//		String names[] = (String[]) all.toArray(new String[0]);
	...
	public static void updateAccounts(ContentResolver cr, Accounts acc) {
		...
		Uri updatedUri = Uri.withAppendedPath(
				MoneyAccountsTableMetaData.CONTENT_URI, String.valueOf(acc.getId()));
	...
	public static void deleteAccounts(ContentResolver cr, int id) {
        ...
        Uri deletedUri = Uri.withAppendedPath(MoneyAccountsTableMetaData.CONTENT_URI,
                String.valueOf(id));
