	...
	/** 定義 items 表格的所有資訊，一個 content provider 可以有多個 table */
		...
		public static final String TABLE_NAME = "money_items";
	        ...
	        public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/" + TABLE_NAME);
	         ...
	         /** 複數與單數的 MIME 型別*/
	        public static final String CONTENT_DIR_TYPE = "vnd.android.cursor.dir/vnd.com.sting.moneysave."+TABLE_NAME;
	        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.com.sting.moneysave."+TABLE_NAME;
